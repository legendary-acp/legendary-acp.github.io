export default function Footer() {
  return (
    <footer className="py-10 border-t border-default bg-surface">
      <div className="max-w-5xl mx-auto px-4 text-sm text-tertiary flex flex-col sm:flex-row items-center justify-between gap-4">
        <div>© {new Date().getFullYear()} Pradyuman</div>

        <div className="font-mono text-xs sm:text-sm text-tertiary">
